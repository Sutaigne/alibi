...
**Live preview:** [**sutaigne.github.io/pc-check**](https://sutaigne.github.io/pc-check/) — three rendered states served from GitHub Pages, full interactivity, no download required.
...
|---|---|---|---|
| **CHEATS DETECTED** (red) | [open ↗](https://sutaigne.github.io/pc-check/pc-mode-cheats-detected_visual.html) | [.txt](./python/examples/pc-mode-cheats-detected.txt) | [.html](./python/examples/pc-mode-cheats-detected_visual.html) |
| **CAPTURE STACK PRESENT** (amber, console-rig mode) | [open ↗](https://sutaigne.github.io/pc-check/console-rig-capture-stack_visual.html) | [.txt](./python/examples/console-rig-capture-stack.txt) | [.html](./python/examples/console-rig-capture-stack_visual.html) |
| **CLEAN** (green, with a Historical demo) | [open ↗](https://sutaigne.github.io/pc-check/pc-mode-clean_visual.html) | [.txt](./python/examples/pc-mode-clean.txt) | [.html](./python/examples/pc-mode-clean_visual.html) |
