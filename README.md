...
| File | State |
|---|---|
| `pc-mode-cheats-detected_visual.html` | red, packed with HIGH findings |
| `console-rig-capture-stack_visual.html` | amber, streamer disclosure shape |
| `pc-mode-clean_visual.html` | green, empty case with a Historical demo |
