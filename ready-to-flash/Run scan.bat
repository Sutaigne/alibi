...
del "%TEMP%\pc-check-pc.summary" 2>nul
del "%TEMP%\pc-check-console.summary" 2>nul
...
echo.
echo   ============================================================
echo    PC Forensic Check  -  Full Scan Suite
echo    Total time: about 2-3 minutes. Window will stay open.
echo   ============================================================
echo.
echo   [Phase 1 of 2]  PC Forensic Check
echo   ------------------------------------------------------------
echo.
...
echo.
echo   ============================================================
echo   [Phase 2 of 2]  Console Rig Audit
echo   ------------------------------------------------------------
echo.
...
if exist "%TEMP%\pc-check-pc.summary" (
    for /f "usebackq tokens=1-5 delims=|" %%a in ("%TEMP%\pc-check-pc.summary") do (
        set "PC_VERDICT=%%a"
        set "PC_TXT=%%b"
        set "PC_CHEAT=%%c"
        set "PC_INPUT=%%d"
...
if exist "%TEMP%\pc-check-console.summary" (
    for /f "usebackq tokens=1-5 delims=|" %%a in ("%TEMP%\pc-check-console.summary") do (
